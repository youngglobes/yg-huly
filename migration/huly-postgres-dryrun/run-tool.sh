...
# Connection parameters are read from huly_pg.conf (same file docker compose uses via .env).
#
# Usage:
...
: "${PG_DB_URL:?PG_DB_URL missing in $CONFIG_FILE}"
